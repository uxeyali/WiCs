...
<div class="off-canvas position-right" id="offCanvasRight" data-off-canvas data-position="right">
  <ul class="vertical dropdown menu" data-dropdown-menu>
   <br>
    ...
    <li class="hover"><a href=<?php print($path . "about/") ?>>Club Info</a></li>
    <li class="hover"><a href=<?php print($path . "opportunities/") ?>>Opportunities</a></li> 
    ...
    <li class="hover"><label><a href=<?php print($path . "news/") ?>>EVENTS</a></label></li>
  </ul>
</div>
  ...
  <div class="sticky" data-sticky data-margin-top="0" data-sticky-on="large"> 
    ...
    <div class="title-bar" data-responsive-toggle="widemenu" data-hide-for="large">
      <div class="title-bar-left">
        <div class="title-bar-title menu-text-bottom"><a href="#"><img  alt="Winona State University Website" class="wsu-flame"  src=<?php print($path . "img/WSU_Flame.png")?>></a><a alt="Home" href=<?php print($path. "") ?> >WOMEN IN COMPUTER SCIENCE</a></div>
    ...
    <div id="widemenu" class="top-bar">
      <div class="top-bar-left">
        <ul class="menu" data-dropdown-menu>        
          <li class="menu-text-bottom"><div><a href="http://www.winona.edu"><img   title="Winona State University Website" class="wsu-flame" src=<?php  print($path. "img/WSU_Flame.png") ?>></a><a title="Home" href= <?php print($path. "") ?> >WOMEN IN COMPUTER SCIENCE</a></div></li>
        ...
        <ul class="menu dropdown" data-dropdown-menu data-closing-time="100">
          ...
          <li class="has-submenu">
            ...
            <ul class="menu submenu vertical" >
              <li class="inside-submenu"><a href=<?php print($path . "about/") ?>><i class="fi-info"></i> CLUB INFO</a></li>
          ...
          <li><a href=<?php print($path . "news/") ?>>EVENTS</a></li>
